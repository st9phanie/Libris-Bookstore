            ...
            <nav className="py-1 w-full">
                <div className="flex flex-col items-center">
                    ...
                    <div className="text-sm font-semibold text-[#132934] flex flex-row border-t-1 w-full ">
                        <Link href="/" className={`justify-center duration-300 w-1/5 hover:bg-gray-200 py-3 items-center pr-40 flex flex-row space-x-2 ${pathname === "/" ? "text-[#e97520] font-bold text-[#132934]" : "hover:bg-gray-200"}`}>
                        ...
                        <Link href="/offers" className={`duration-300 w-1/5 hover:bg-gray-200 py-3 items-center px-10 flex flex-row gap-x-2 ${pathname === "/offers" ? "text-[#e97520] font-bold text-[#132934]" : "hover:bg-gray-200"}`}>
