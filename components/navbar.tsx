        ...
        <div className="sticky top-0 z-50 bg-[#fdfdfd] shadow flex justify-between">
            <nav className="py-1 w-full">
                <div className="flex flex-col items-center">
                    <div className="container flex items-center flex-row justify-between py-4 px-39 w-full">
                        <Link href="/" className="cursor-pointer ">
                            <div className="flex flex-row items-center gap-x-3 text-[#132934]">
                                <p className=" viaoda text-3xl font-semibold tracking-[1.2px]">Libris</p>
                            </div>
                        </Link>

                        <div className="relative md:min-w-3xl flex flex-row gap-x-2">
                            <input
                                placeholder="Search"
                                className="px-4 py-2 w-full bg-[#EBEBE5] border-2 text-black"
                            />
                            <button className="bg-[#e97520] place-items-center px-4 py-2">
                                <svg
                                    className=""
                                ...
                                <DropdownMenuContent>
                                    ...
                                    <DropdownMenuItem>
                                        <form method="POST" action="/auth/signout">
                                            <button type="submit" className="text-red-500 w-full text-left">Log out</button>
                                        </form>
                                    </DropdownMenuItem>
                                </DropdownMenuContent>
                            </DropdownMenu>
                    ...
                    <div className="text-sm font-semibold text-[#132934] flex flex-row border-t-1 w-full">
                        <Link href="/" className={`duration-300 w-1/4 hover:bg-gray-200 py-3 items-center justify-center flex flex-row space-x-2 ${pathname === "/" ? "text-[#e97520] font-bold text-[#132934]" : "hover:bg-gray-200"}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32"><path fill="currentColor" d="m16 2.594l-.719.687l-13 13L3.72 17.72L5 16.437V28h9V18h4v10h9V16.437l1.281 1.282l1.438-1.438l-13-13zm0 2.844l9 9V26h-5V16h-8v10H7V14.437z" /></svg>
                            <p className="text-center">Home</p>
                        </Link>
                        <Link href="/books" className={`duration-300 w-1/4 hover:bg-gray-200 py-3 items-center justify-center flex flex-row gap-x-2 ${pathname === "/books" ? "text-[#e97520] font-bold text-[#132934]" : "hover:bg-gray-200"}`}>
                        ...
                        <Link href="/contact" className={`duration-300 w-1/4 hover:bg-gray-200 py-3 items-center justify-center flex flex-row gap-x-2 ${pathname === "/contact" ? "text-[#e97520] font-bold text-[#132934]" : "hover:bg-gray-200"}`}>
                        ...
                        <Link href="/offers" className={`duration-300 w-1/4 hover:bg-gray-200 py-3 items-center justify-center flex flex-row gap-x-2 ${pathname === "/offers" ? "text-[#e97520] font-bold text-[#132934]" : "hover:bg-gray-200"}`}>
