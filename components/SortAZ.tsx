...
export const SortAZ = ({ onToggle }: SortAZProps) => {
  ...
  return (
    <div onClick={toggleSort} className="cursor-pointer">
      {az ? (
        <svg
