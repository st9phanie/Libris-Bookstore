        ...
        {paginatedBooks.map((pair, key) => (
          ...
          >
            ...
            {pair.bookAuthor.map((author, idx) => (
              <div key={idx} className="text-xs text-gray-600 truncate w-full pb-1 flex flex-row gap-x-[2px]">
            ...
            <div className="flex flex-row mt-2 items-center justify-between w-full">
              ...
              <button className="text-[#132934] hover:text-[#E97520] transition-colors">
                {/* Cart Icon */}
                <svg className="cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32" fill="currentColor">
