  ...
  const handleAddToCartClick = async (bookId: number) => {
    ...
    if (result.error) {
      ...
      toast.success("Added to cart!", {
        description: "The item has been added or quantity increased.",
        duration: 2000,
        action: {
          label: "View Cart",
          onClick: () => router.push('/cart'), // Assuming you have a /cart route
        },
      });
          ...
          >
            ...
            <div className="flex flex-row mt-2 items-center justify-between w-full">
              ...
              <button
                ...
                onClick={() => handleAddToCartClick(book.id)} // Call the new handler with book.id
              >
